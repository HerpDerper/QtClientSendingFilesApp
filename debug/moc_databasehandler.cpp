...
QT_MOC_LITERAL(1, 16, 9), // "MoveToLog"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "text"
QT_MOC_LITERAL(4, 32, 4), // "init"
QT_MOC_LITERAL(5, 37, 20), // "InsertFileToDataBase"
QT_MOC_LITERAL(6, 58, 6) // "packet"

    },
    "DataBaseHandler\0MoveToLog\0\0text\0init\0"
    "InsertFileToDataBase\0packet"
};
...
void DataBaseHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->MoveToLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->init(); break;
        case 2: _t->InsertFileToDataBase((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DataBaseHandler::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DataBaseHandler::MoveToLog)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DataBaseHandler::staticMetaObject = {
...
// SIGNAL 0
void DataBaseHandler::MoveToLog(QString _t1)
{
